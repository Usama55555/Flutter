...
import 'package:spinbottlegame/add_truths.dart';
import 'package:spinbottlegame/playersscreen.dart';
import 'package:spinbottlegame/ply.dart';

class DataScreent extends StatefulWidget {
  final int numberOfPlayers;

  DataScreent({required this.numberOfPlayers});

  @override
  _DataScreentState createState() => _DataScreentState();
}

class _DataScreentState extends State<DataScreent> {
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PlayerListScreent(allplayers: playerNames, bottleImagePath: selectedBottleImage),
                          ),
                        );
                      },
                      child: Row(
                ...
                child: Flexible(
                  child: Container(
                      ...
                      child: TextButton(
                          ...
                          child: Row(
                            children: [
                              Align(alignment: Alignment.centerLeft,child: IconButton(onPressed: (){}, icon: Icon(Icons.add,color: Colors.white,),)),
                              const Text(
                                  'Add Task',
                                  style: TextStyle(color: Colors.white, fontSize: 18)
                              ),
